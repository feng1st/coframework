    ...
    public Object getExtension(Class<?> extensibleInterface, BizScenario bizScenario) {
        ...
        if (extension == null
            ...
            throw new IllegalArgumentException(String.format(
                    ...
                    TypeStringUtils.toString(extensibleInterface),
                    bizScenario));
        }
    ...
    private void register(Object extension) {
        ...
        if (extensibleInterfaces.isEmpty()) {
            throw new IllegalStateException(String.format(
                    ...
                    TypeStringUtils.toString(extensionClass)));
        }
    ...
    private void registerExtension(Class<?> extensibleInterface, BizScenario bizScenario, Object extension) {
        ...
        if (existing != null) {
            throw new IllegalStateException(String.format(
                    ...
                    TypeStringUtils.toString(extensibleInterface),
                    bizScenario,
                    TypeStringUtils.toString(ClassUtils.getTargetClass(existing)),
                    TypeStringUtils.toString(ClassUtils.getTargetClass(extension))));
        }
    }
